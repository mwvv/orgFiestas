...
INSERT INTO invitacion (evento_id, usuario_invitado_id, usuario_anfitrion_id, estado, activo, fecha_registro)
VALUES (1, 3, 1, 'ACEPTADA', TRUE, CURDATE());

INSERT INTO invitacion (evento_id, usuario_invitado_id, usuario_anfitrion_id, estado, activo, fecha_registro)
VALUES (1, 4, 1, 'PENDIENTE', TRUE, CURDATE());

INSERT INTO invitacion (evento_id, usuario_invitado_id, usuario_anfitrion_id, estado, activo, fecha_registro)
VALUES (2, 5, 2, 'ACEPTADA', TRUE, CURDATE());
...
INSERT INTO grupo_evento (evento_id, usuario_id, rol, activo, fecha_registro)
VALUES (1, 3, 'PARTICIPANTE', TRUE, CURDATE());

INSERT INTO grupo_evento (evento_id, usuario_id, rol, activo, fecha_registro)
VALUES (2, 2, 'ANFITRION', TRUE, CURDATE());

INSERT INTO grupo_evento (evento_id, usuario_id, rol, activo, fecha_registro)
VALUES (2, 5, 'PARTICIPANTE', TRUE, CURDATE());